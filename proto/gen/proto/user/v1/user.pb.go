...
type ListUsersRequest struct {
	...
	CompanyId     int64                  `protobuf:"varint,3,opt,name=company_id,json=companyId,proto3" json:"company_id,omitempty"` // Filter by company
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListUsersRequest) GetCompanyId() int64 {
	if x != nil {
		return x.CompanyId
	}
	return 0
...
const file_proto_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x18proto/user/v1/user.proto\x12\auser.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd5\x01\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x12\x1d\n" +
	"\n" +
	"company_id\x18\x04 \x01(\x03R\tcompanyId\x129\n" +
	"\n" +
	...
	"\n" +
	"company_id\x18\x03 \x01(\x03R\tcompanyId\"7\n" +
	...
	"\n" +
	"company_id\x18\x03 \x01(\x03R\tcompanyId\"N\n" +
